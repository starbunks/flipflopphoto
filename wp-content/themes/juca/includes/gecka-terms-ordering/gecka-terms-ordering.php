...
class Gecka_Terms_Ordering {
    ...
    private function __construct () {
    	...
    	self::$plugin_url 	= get_template_directory_uri() . '/includes/gecka-terms-ordering/';

    	// register_activation_hook( __FILE__, array( $this, 'activation_hook' ) );
    	// function ml_menu_order_activate() {
	    	add_action( 'admin_init', array( $this, 'activation_hook' ) );
    	// }
    	// wp_register_theme_activation_hook('omni', 'ml_menu_order_activate');
...
if( function_exists('add_term_ordering_support') )
	add_term_ordering_support ('ml_portfolio_category');