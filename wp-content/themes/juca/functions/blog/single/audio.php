...
$audio = ml_p( get_post_meta( get_the_ID(), '_ml_post_audio', true ) );

?>

<!-- .ml-post-entry -->
<div class="ml-post-entry ml-entry-audio">

	<?php 

	echo ml_get_featured_image( '<br>' );
	...
	<div class="ml-read-wrapper">
		...
		<div class="ml-post-format">
			...
			<!-- .ml-post-icon -->
			<div class="ml-post-icon ml-post-i-audio">
				<span>&#x28;</span>
			</div>
			<!-- /.ml-post-icon -->
		</div>
